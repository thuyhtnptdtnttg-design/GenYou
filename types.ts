...
export type ScreenState = 'welcome' | 'menu' | 'quiz_mbti' | 'quiz_holland' | 'quiz_iq' | 'quiz_eq' | 'quiz_disc' | 'passport_mbti' | 'passport_holland' | 'passport_iq' | 'passport_eq' | 'passport_disc' | 'admin' | 'comprehensive_report';
